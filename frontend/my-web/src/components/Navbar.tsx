...
import { LogOut, Shield, Video, Users, Menu, X } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/dashboard" className="flex items-center gap-2.5 group">
            <div className="w-9 h-9 rounded-lg bg-navy-800 flex items-center justify-center shadow-md group-hover:shadow-lg transition-shadow">
              <Shield className="w-5 h-5 text-white" />
            </div>
            <div>
              <span className="text-lg font-bold text-navy-800 tracking-tight">Iverto.ai</span>
          ...
          <div className="hidden md:flex items-center gap-3">
            <div className="text-right">
              ...
              <span className={`inline-block text-[10px] font-semibold uppercase tracking-wider px-2 py-0.5 rounded-full border ${roleBadgeColor[user.role]}`}>
                {user.role}
              </span>
            </div>
          ...
          <div className="border-t border-gray-100 pt-2 mt-2 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <span className={`text-[10px] font-semibold uppercase tracking-wider px-1.5 py-0.5 rounded-full border ${roleBadgeColor[user.role]}`}>
                  {user.role}
                </span>
              </div>
            </div>
